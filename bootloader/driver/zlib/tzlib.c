...
int raw_uncompress(
    Bytef* dest, uLongf* destLen, const Bytef* source, uLongf sourceLen) {
    ...
    status = tinfl_decompress(
        &decomp, (const mz_uint8*)source, &inLen, (mz_uint8*)dest,
        (mz_uint8*)dest, &outLen, TINFL_FLAG_USING_NON_WRAPPING_OUTPUT_BUF);
