...
#if FLARE_AARCH64_VERSAL
#include "versal-flash.h"
#elif FLARE_ARM_ZYNQ7000
...
flash_ReadRegister(uint8_t reg, uint16_t* value)
{
    ...
    flash_TransferBuffer_SetCommMethod(flash_buf, FLASH_COMM_METHOD_SINGLE_TOP);
...
flash_SetWEL(void)
{
    ...
    flash_TransferBuffer_SetCommandLen(flash_buf, FLASH_COMMAND_SIZE);
    flash_TransferBuffer_SetCommMethod(flash_buf, FLASH_COMM_METHOD_SINGLE_BOTTOM);
